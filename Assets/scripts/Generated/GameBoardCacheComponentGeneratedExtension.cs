...
namespace Entitas {
    public partial class Entity {
        public GameBoardCacheComponent gameBoardCache { get { return (GameBoardCacheComponent)GetComponent(CoreComponentIds.GameBoardCache); } }
        ...
        public Entity AddGameBoardCache(Entitas.Entity[,] newGrid) {
            var component = CreateComponent<GameBoardCacheComponent>(CoreComponentIds.GameBoardCache);
